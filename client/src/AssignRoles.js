...
function AssignRoles() {
  ...
  const handlerSubmitRMS = async (event) => {
    ...
    try {
      ...
      alert("Something wrong with Supplier address!!!");
    }
  };
  const handlerSubmitMAN = async (event) => {
    ...
    try {
      ...
      alert("Something wrong with Former address!!!");
    }
  };
  const handlerSubmitDIS = async (event) => {
    ...
    try {
      ...
      alert("Something wrong with Distributor address!!!");
    }
  };
  const handlerSubmitRET = async (event) => {
    ...
    try {
      ...
      alert("Something wrong with Retailer address!!!");
    }
  };
  ...
  return (
    <div>
      ...
      <h4 className="header">Distributors</h4>
      <div className="row">
        <div className="box1 orange">
          <form
      ...
      <h4 className="header">Retailers</h4>
      <div className="row">
        <div className="box1 orange">
          <form
